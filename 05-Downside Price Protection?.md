...
Downside Price Protection is an optional feature that helps users safeguard their token exchanges from sudden drops in value.

When using Downside Protection, received tokens are shielded against price decreases for a selected period. This feature works by purchasing a put option during the transaction, which acts as insurance against the token's value falling. 
